...
slug: wallets/reference/account-kit/react-native/hooks/useSendVerificationCode
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        `Partial`\<`Omit`\<`UseMutationOptions`\<`void`, `Error`, [`SendVerificationCodeParams`](/docs/wallets/reference/account-kit/react-native/interfaces/SendVerificationCodeParams), `unknown`>, `"mutationFn"` | `"mutationKey"`>>
      </td>
...
[`UseSendVerificationCodeResult`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseSendVerificationCodeResult)
