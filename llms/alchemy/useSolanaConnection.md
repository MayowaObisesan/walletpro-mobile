...
slug: wallets/reference/account-kit/react-native/hooks/useSolanaConnection
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [`SolanaConnectionHookParams`](/docs/wallets/reference/account-kit/react-native/type-aliases/SolanaConnectionHookParams)
      </td>
...
[`SolanaConnection`](/docs/wallets/reference/account-kit/react-native/interfaces/SolanaConnection)
