...
slug: wallets/reference/account-kit/react-native/hooks/useSignMessage
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [`UseSignMessageArgs`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseSignMessageArgs)
      </td>
...
[`UseSignMessageResult`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseSignMessageResult)
