...
slug: wallets/reference/account-kit/react-native/hooks/useClientActions
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [`UseClientActionsProps`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseClientActionsProps)\<`TTransport`, `TChain`, `TActions`>
      </td>
...
[`UseClientActionsResult`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseClientActionsResult)\<`TActions`>
