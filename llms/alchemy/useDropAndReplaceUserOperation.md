...
slug: >-
  wallets/reference/account-kit/react-native/hooks/useDropAndReplaceUserOperation
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [`UseDropAndReplaceUserOperationArgs`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseDropAndReplaceUserOperationArgs)\<`TEntryPointVersion`, `TAccount`>
      </td>
...
[`UseDropAndReplaceUserOperationResult`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseDropAndReplaceUserOperationResult)\<`TEntryPointVersion`, `TAccount`>
