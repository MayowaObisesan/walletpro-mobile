...
slug: wallets/reference/account-kit/react-native/hooks/useSetEmail
layout: reference
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        `Partial`\<`Omit`\<`UseMutationOptions`\<`void`, `Error`, [`SetEmailParams`](/docs/wallets/reference/account-kit/react-native/type-aliases/SetEmailParams), `unknown`>, `"mutationFn"` | `"mutationKey"`>>
      </td>
...
[`UseSetEmailResult`](/docs/wallets/reference/account-kit/react-native/type-aliases/UseSetEmailResult)
